...
public class Activity5 {
	...
	public void smsTest() {
		...
		driver.findElement(MobileBy.AndroidUIAutomator(contactBoxLocator)).sendKeys("7411011265");
		((AndroidDriver<MobileElement>) driver).longPressKey(new KeyEvent(AndroidKey.ENTER));
